...
namespace RedisclosureComments
{
    ...
    public class RediscComment
    {
        ...
        private void EncompassApplication_LoanOpened(object sender, EventArgs e)
        {
            ...
            EncompassApplication.CurrentLoan.BeforeCommit += CurrentLoan_BeforeCommit;
        ...
        private void CurrentLoan_BeforeCommit(object source, CancelableEventArgs e)
        {
            var disSent = EncompassApplication.CurrentLoan.Log.Disclosures2015;
            int sentDateLast = disSent.Count - 1;
        ...
        private void CurrentLoan_FieldChange(object source, EllieMae.Encompass.BusinessObjects.Loans.FieldChangeEventArgs e)
        {
            Loan loan = EncompassApplication.CurrentLoan;
            User user = EncompassApplication.CurrentUser;
            UserGroup pilotUser = EncompassApplication.Session.Users.Groups.GetGroupByName("Redisclosure Pilot");
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("Something went wrong with acknowledging Disclosure Type");
            }
        ...
        private void Approval_Package()
        {
            try
            {
                ...
                Loan loan = EncompassApplication.CurrentLoan;
                User user = EncompassApplication.CurrentUser;
                List<string> alertapprList = new List<string> { "CX.RD.APPR.ALERT1", "CX.RD.APPR.ALERT2", "CX.RD.APPR.ALERT3", "CX.RD.APPR.ALERT4" };
                List<string> resolveapprList = new List<string> { "CX.RD.APPR.RESOLVE1", "CX.RD.APPR.RESOLVE2", "CX.RD.APPR.RESOLVE3", "CX.RD.APPR.RESOLVE4" };
                List<string> whoapprList = new List<string> { "CX.RD.APPR.WHO1", "CX.RD.APPR.WHO2", "CX.RD.APPR.WHO3", "CX.RD.APPR.WHO4" };
                List<string> cocapprList = new List<string> { "CX.RD.APPR.COC1", "CX.RD.APPR.COC2", "CX.RD.APPR.COC3", "CX.RD.APPR.COC4" };
                //List<string> docapprList = new List<string> { "CX.RD.COC.DOC1", "CX.RD.COC.DOC2", "CX.RD.COC.DOC3", "CX.RD.COC.DOC4"};
                List<string> procapprList = new List<string> { "CX.RD.APPR.COC.PROCESSOR1", "CX.RD.APPR.COC.PROCESSOR2", "CX.RD.APPR.COC.PROCESSOR3", "CX.RD.APPR.COC.PROCESSOR4" };
                List<string> closerapprList = new List<string> { "CX.RD.APPR.COC.CLOSER1", "CX.RD.APPR.COC.CLOSER2", "CX.RD.APPR.COC.CLOSER3", "CX.RD.APPR.COC.CLOSER4" };
